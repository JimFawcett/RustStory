...
/////////////////////////////////////////////////
// Demo functions
mod pass_by_function_demo;
use pass_by_function_demo::*;
/*-----------------------------------------------
...
fn main() {
  show_title("test functions");
  putln();
  let d = 3.149257;
  show("this is a value:", &d);
  putln();
  ...
  // /*-------------------------------------------*/
  // separator(48);
  // sub_title("Pass copy type by value");
  // show_op("let f1 = 3.14159");
  // let f1 = 3.14159;  // copy type
  // show_op("pass_by_value(f1)");
  // pass_by_value(f1);
  // show_op("after return");
  // println!("  arg: {f1} still valid - no side effects");

  // /*-------------------------------------------*/
  // separator(48);
  // sub_title("Pass move type by value");
  // show_op("let st = \"xyz\".to_string()");
  // let st = "xyz".to_string();
  // show_op("pass_by_value(st)");
  // pass_by_value(st);
  // println!("  st moved - no longer valid");
  // ////////////////////////////////////////////////
  // // next statement fails to compile - s1 moved
  // // println!("{st}");
  ...
  // /*-------------------------------------------*/
  // separator(48);
  // sub_title("Pass copy type by reference");
  // let f1 = 3.14159;
  // pass_by_ref(&f1);
  // show("\n  after pushing a, s = ",&s);
